# drawoheriter — 67-Day Content Plan

Edit any field freely. When you're done, tell Claude "read plan.md and lock it in."

**Editing guide:**
- Change Hook or Sub-text → Claude rewrites the full carousel to match
- Fill in [brackets] with real numbers before locking in
- Edit or delete a Bubble → Claude respects whatever you leave
...
### Day 1
**Hook:** I built a SaaS and have **zero paying customers.**
**Sub-text:** Here is what week 1 actually looked like.
**Stat slide:** 0 / paying customers after 7 days live
**Content angles:**
- Built in evenings and weekends while working full-time
- Launched quietly — no Product Hunt, no announcement
- Sent first cold emails manually before automating
...
- Unsexy markets have real paying customers and fewer competitors
...
**Content angles:**
- No standup. No Slack. No one to share a small win with.
- Made a decision I am still not sure about. Had to live with it alone.
- Loneliness is not about people — it is about no one catching your blind spots
...
- 3 sequences: intro at day 1, follow-up at day 4, final at day 8
- Reply-to goes to a real inbox I check every morning
...
- Showed it anyway because waiting for perfect means never shipping
- The feedback was useful. The silence after was more useful.
...
- 8pm Howard is not the same as 6am Howard — pick your hours deliberately
- What I gave up: Netflix, most social plans, some sleep
...
- One thing that failed completely
...
- With MCP: Claude can read your database, control a browser, look up live documentation
- Analogy: Claude without MCP is a consultant with no internet. MCP gives it the internet plus tools.
...
- Playwright MCP: Claude opens a real browser and tests your app by itself. Finds bugs before you do.
- context7 MCP: Claude looks up the latest documentation so it does not give you outdated advice.
...
**Content angles:**
- CLAUDE.md is an instruction file that lives in your project folder
- Every time Claude works on your code, it reads this file first — automatically
- Think of it like an employee handbook for your AI
- What goes in it: your design rules, deployment rules, database rules, things Claude should never do
...
- My job: describe what I want, review the output, catch the mistakes
- The skill that actually matters: knowing WHAT to build, not writing every line
- What I can ship in one evening vs what used to take a dev team a week
...
- Rule 2: No building context in my head during work hours — full separation keeps both clean
- Rule 3: One weekend morning per week is for planning only, no building — prevents reactive work
- The hard part: your day job will always feel urgent. Your side project never does. You have to manufacture the urgency yourself.
...
- /feature: Claude explores the codebase, plans what to change, shows you the plan, waits for your approval, then builds it
- /fix: Claude reproduces the bug, finds the root cause, fixes it, verifies with screenshots — before reporting done
- Why this matters: Claude stops cutting corners. The same quality checklist runs every single time.
...
- Type 2: Polite no — actually useful, tells you something
- Type 3: Interested but not yet — requires follow-up discipline
- Type 4: The one that makes it worth it — rarer than you think, more motivating than you expect
...
- The non-math reason: I am not sure I am right yet. The job buys me time to find out.
...
- Mistake 2: Optimising the product before validating demand
- Mistake 3: Waiting for it to be "ready" before showing anyone
- Mistake 4: Measuring the wrong metric (signups vs actual engagement)
...
- The metric that did not move at all — and what I am doing about it
- One thing I am genuinely surprised by
...
- Nobody outside consulting cares what tier your firm was
- The identity shift from "consultant at X" to "building something no one has heard of"
...
- The dangerous habit: mistaking analysis for action
...
- Reason 2: Used to clients defining the problem — bad at choosing which problem to solve
- Reason 3: Optimise for looking right, not being right
...
**Content angles:**
- Making slides teaches you to communicate. It does not teach you to build.
- The product reveals whether your thinking was right. The slide never does.
- What I had to learn from scratch: shipping, tolerating ugly first versions
...
- First time I saw a feature go from Slack to live in two days — I did not know that was possible
...
- The product is a direct reflection of your thinking — that is terrifying
...
- The colleagues: genuinely sharp people who pushed you
- The structured feedback: someone always told you where you stood
...
- Solving problems that felt important in the room and irrelevant a year later
- Managing up more than building down
- Travelling for work that could have been an email
- The identity that came from the firm name, not from what you built
- Timesheets
...
**Content angles:**
- Real runway calculation: savings, burn rate, risk tolerance
- Going all in is romantic. Going broke is not.
- The job funds the experiment. The experiment might make the job optional.
...
- The credential opened doors. The experience gave me a pattern library.
- What I would change: leave one year earlier
...
**Content angles:**
- The post that got the most saves (and why)
- The honest take that made people uncomfortable
- What this theme taught me about who is actually following
...
## THEME 3 — Fitness and discipline (Days 36–49)
Overline label: **Fitness and discipline**
...
**Content angles:**
- The gym has no shortcuts — neither does a startup
- Consistency over intensity: showing up every day beats going hard occasionally
- The middle is where most people quit. In fitness and in business.
...
**Content angles:**
- What I eat on a normal workday
- What I eat on a heavy building night
- The one thing I eat that most fitness people would cringe at
...
- Sleep: the one free recovery tool most people underuse
- Protein: the only supplement that matters at this stage
...
- Rule 2: On bad days, the bar is just "do not leave immediately"
- Rule 3: A bad session counts. Skipping does not.
...
**Content angles:**
- Doing boring things repeatedly without needing them to feel meaningful
- The sleep I actually get (honest number, not the recommended one)
- What I sacrifice to make the schedule work
...
**Content angles:**
- Training for looks is exhausting — feedback loop is slow and subjective
- Training for strength is objective: the number goes up or it does not
- Side effect: the aesthetics came anyway
...
- The gym does not care about your meetings or cold email open rates
- Physical output clears mental noise — personal data, not theory
...
- As a baseline management tool, it is the cheapest and most reliable one I have
- What a no-workout week actually feels like for me — specific and honest
...
**Content angles:**
- Balance is not the right word — sequencing and protecting a small number of things is
- What I protect no matter what: training, sleep (mostly), one unhurried meal a day
- What gets negotiated: social life, leisure, some sleep, most weekends
...
- What stuck: a daily list and a weekly review
- The system that sounds boring is the one that lasts
...
**Content angles:**
- The physical changes — specific and honest
- The mental changes: higher baseline, faster recovery from stress
- What changed in how I work and make decisions
...
## THEME 4 — Building my finances (Days 50–63)
Overline label: **Building my finances**
...
**Content angles:**
- Knowing what a company does is not the same as knowing it is mispriced
- The clarity trap: understanding a company does not equal conviction it will outperform
- What I was doing: buying stories, not bets
...
- What I spent on in consulting that I do not miss
...
- Why timing the market is gambling with extra steps
- What I invest in and why (index-first, everything else is secondary)
...
- What changed in how I invest because of it
...
- The lifestyle you build young is the one you will need to fund forever
...
- What "enough" means when you are trying to build something
- Financial runway and creative risk-taking are directly connected
...
**Content angles:**
- What I tried: individual stocks, sector bets, trying to time cycles
- What I do now: boring, diversified, automated monthly purchases
- Most people who beat the market for one year underperform over ten
...
- What I have held, what I traded, what I avoided
- People I know who made money and people who lost it — what was different
...
- Financial stress destroys decision-making — this is not optional
- What I had to build up before I felt comfortable starting
